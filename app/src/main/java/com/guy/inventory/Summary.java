    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSummaryBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Summary.this, SummaryBuy.class);
        ...
        btnSummarySale.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Summary.this, SummarySale.class);
        ...
        btnSummaryWage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Summary.this, SummaryWage.class);
